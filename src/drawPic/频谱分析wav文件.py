...
sampling_rate = samplerate  # 采样频率为8000Hz
fft_size = len(signal)  # FFT处理的取样长度
...
x = signal  # 两个正弦波叠加，156.25HZ和234.375HZ
...
pl.xlabel(u"Time(S)")
pl.title(u"'你好'语音的声波图和频谱图(0-8000Hz)")
pl.subplot(212)
pl.plot(freqs[freqs < 8000], xfp[freqs < 8000])
pl.xlabel(u"Freq(Hz)")
